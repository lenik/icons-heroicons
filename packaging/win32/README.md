...
.\build.ps1 -Name icons-heroicons -Version 1.2.3
```
...
```
<project>/.config/icons-heroicons/<packaging>.build-host
$HOME/.config/icons-heroicons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-heroicons
```
